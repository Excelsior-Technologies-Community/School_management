...
import { AlertCircle, Award, BookOpen, Calendar, CheckCircle2, Clock, FileText, LogOut, UploadCloud, User, Menu, X } from 'lucide-react';
...
const StudentDashboard = () => {
  ...
  return (
    <div className='min-h-screen bg-slate-50 flex flex-col md:flex-row relative'>
      ...
      {/* Dimmed Background Backdrop for Mobile Sidebar view overlay */}
      {isSidebarOpen && (
        <div
      ...
      {/* Main Core Navigation Sidebar Container */}
      ...
      {/* Main Content Area Workspace view wrapper */}
